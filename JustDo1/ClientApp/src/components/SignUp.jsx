...
//uberu, idu spat' - ne uspel
	...
	validateForm() {
		...
		this.state.passwordValid && this.state.confPasswordValid});
	}
		...
		return (
			<div className="valid-form">
				...
				<div className="start-footer">
					...
					<a onClick={()=> this.changePage(2)}>Terms conditions
					</a> and <a onClick={()=> this.changePage(3)}>Privacy Policy</a>
				</div>
			</div>
		);
	}
